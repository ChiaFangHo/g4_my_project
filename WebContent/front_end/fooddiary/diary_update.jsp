                ...
                <div class="add_content"><br>
                    ...
                    <textarea class="text" name="text" placeholder="請輸入文章內容..."><%= diaryVO.getText() %></textarea>
                        ...
                        <label class="add_pic_1">
                            <div class="preview" id="preview"><img src="PicReader?diaryID=<%= diaryVO.getDiaryID() %>" id="view_1" title="請添加圖片" onerror="this.src='<%=request.getContextPath()%>/front_end/GP4_html_cf/cf_css/do1.jpg;this.onerror=null'"/></div> 
                        ...
                        <label class="add_pic_2">
                            <div class="preview" id="preview"><img src="PicReader2?diaryID=<%= diaryVO.getDiaryID() %>" id="view_2" title="請添加圖片" onerror="this.src='<%=request.getContextPath()%>/front_end/GP4_html_cf/cf_css/do2.jpg;this.onerror=null'"/></div> 
                        ...
                        <label class="add_pic_3">
                            <div class="preview" id="preview"><img src="PicReader3?diaryID=<%= diaryVO.getDiaryID() %>" id="view_3" title="請添加圖片" onerror="this.src='<%=request.getContextPath()%>/front_end/GP4_html_cf/cf_css/do3.jpg;this.onerror=null'"/></div> 
