...
<body>
    ...
    <header>
        ...
        <ul class="header_li">
            ...
            <li>
                <a class="menu_title" href="#">會員登出</a>
            </li>
        </ul>
    ...
    <main>
        <p class="breadcrumb"><a style="color: blue;" href="<%=request.getContextPath()%>/front_end/GP4_html_cf/group4_diary.html" >食健生活</a>  > 
        <span id="breadcrumb_type" style="color: blue;"> <%= map.get(diaryVO.getDiaryType()) %> </span> >
        <span id="breadcrumb_subject" style="color: blue;">文章主題:<%= diaryVO.getSubject() %></span> </p>
       <br>
        ...
        <div class="article">
            <div class="article_header">
                ...
                <div class="article_info">
                    <div class="author">    
                        ...
                        <span class="author_name" data-custId=<%=diaryVO.getCustID()%> data-diaryId=<%=diaryVO.getDiaryID()%>>作者: 加法真是太神奇了 (會員編號:<%= diaryVO.getCustID() %>) </span>
                        <input class="add_friend" type="button" name="加好友" value="+ 加好友">
                    </div>
                    <br>
                    <span>發表於 <fmt:formatDate pattern="yyyy/M/d hh:mm" value="<%= diaryVO.getCreatedTime() %>"/></span>
			...
			<div class="container">
                ...
                <div class="slide_img" id="one">			
                        ...
                        <img src="PicReader?diaryID=<%= diaryVO.getDiaryID() %>" onerror="this.src='<%=request.getContextPath()%>/front_end/GP4_html_cf/cf_css/do1.jpg;this.onerror=null'"/>
                ...
                <div class="slide_img" id="two">
                        ...
                        <img src="PicReader2?diaryID=<%= diaryVO.getDiaryID() %>" onerror="this.src='<%=request.getContextPath()%>/front_end/GP4_html_cf/cf_css/do2.jpg;this.onerror=null'"/>
                        
                            <label class="prev" for="i1"><span>&#x2039;</span></label>
                            <label class="next" for="i3"><span>&#x203a;</span></label>                   
                </div>                       
                <div class="slide_img" id="three">
                        <img src="PicReader3?diaryID=<%= diaryVO.getDiaryID() %>" onerror="this.src='<%=request.getContextPath()%>/front_end/GP4_html_cf/cf_css/do3.jpg;this.onerror=null'"/>	
         ...
         <div id="parent">
            ...
            <div id="box"><em>目前尚無留言內容，請留言</em></div>
            <br/>
        </div>    
    </main>
    <footer>
